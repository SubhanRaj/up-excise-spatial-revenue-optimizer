...
const COLUMN_GUIDE: unknown[][] = [
  ...
  [FRIENDLY_LABELS.adjacent_thanas_raw, 'Names of the Thanas that directly border this shop\'s Thana (not the whole district), comma-separated.\nइस दुकान के थाने से सटे (adjacent) थानों के नाम — पूरे जिले के नहीं — अल्पविराम (,) से अलग करके लिखें।', 'Optional / वैकल्पिक', 'Must be in the same district as this Thana — cross-district entries are automatically rejected by the portal.\nयह थाना जिस जिले में है, वे थाने भी उसी जिले के होने चाहिए — दूसरे जिले के थाने अपने-आप अस्वीकृत हो जाते हैं।'],
