...
export async function generateTemplate(districtName: string, units: string[], existingRows?: StagedRow[]): Promise<Blob> {
  ...
  wsGuide.spliceRows(1, 0, [
    ...
    '⚠ Enter figures for FY 2025-26 (1 Apr 2025 – 31 Mar 2026) only — the previous financial year. Do NOT enter FY 2026-27 (current-year) figures; a district that uploaded current-year data will have it cleared and must re-enter FY 2025-26. Every revenue field is in rupees (₹), except MGQ Quantity on Bhang Shop rows, which is a quantity in units/kg — the portal multiplies it by ₹20/unit to get the revenue figure, so do not enter a pre-calculated rupee amount there.\n' +
    'केवल FY 2025-26 (1 अप्रैल 2025 – 31 मार्च 2026), यानी पिछले वित्तीय वर्ष के आंकड़े भरें। FY 2026-27 (चालू वर्ष) के आंकड़े न भरें; चालू वर्ष का डेटा अपलोड करने वाले जिले का डेटा हटा दिया जाएगा और उसे FY 2025-26 दोबारा भरना होगा। हर राजस्व field रुपये (₹) में है, सिवाय Bhang Shop की MGQ Quantity के — वह एक मात्रा (यूनिट/किलोग्राम) है; पोर्टल इसे ₹20 प्रति यूनिट से गुणा करके राजस्व निकालता है, इसलिए वहां सीधे रुपये की गणना करके न भरें।',
  ]);
