...
const COLUMN_GUIDE: unknown[][] = [
  ...
  [FRIENDLY_LABELS.adjacent_thanas_raw, 'Names of Thanas adjacent to this Thana, comma-separated. Example: Kotwali, Hazratganj\nइस थाने से सटे (adjacent) थानों के नाम, अल्पविराम (,) से अलग करके। उदाहरण: Kotwali, Hazratganj', 'All shop types (please always fill in) / सभी प्रकार (कृपया हमेशा भरें)', 'Only list Thanas within this district. On the Verify page, a name turns red if it doesn\'t (yet) appear as a Thana elsewhere in this district\'s own uploaded data — this is NOT an error and does not block submission; it usually just means no shop from that Thana has been uploaded yet in this batch. Still worth a spelling check, but a red name by itself is fine.\nकेवल इसी जिले के थाने लिखें। Verify पेज पर, अगर कोई नाम अभी तक इस जिले के अपने अपलोड किए गए डेटा में कहीं और Thana के रूप में मौजूद नहीं है, तो वह नाम लाल हो जाता है — यह कोई त्रुटि नहीं है और इससे सबमिशन नहीं रुकता; आमतौर पर इसका मतलब बस इतना है कि उस Thana की कोई दुकान अभी तक इस batch में अपलोड नहीं हुई। फिर भी वर्तनी एक बार जांच लें, लेकिन अकेले लाल नाम होना कोई समस्या नहीं है।'],
