      ...
      <div className="flex items-start gap-3 flex-wrap">
        ...
        <HelpPanel pageKey="admin_export" title="Full State Export — How it works">
          <ul className="list-disc list-inside space-y-1">
            ...
            <li><strong>Workbook structure</strong> — <strong>Summary</strong> (state totals, shop-type breakdown, division rollup), <strong>Districts</strong> (75-row master table), <strong>Circle-Sector Summary</strong> (every circle/sector across the state), <strong>All Shops (Flat)</strong> (every shop, one sheet, pivot-table friendly), then one sheet per district — 75 tabs, including districts with no shops yet.</li>
