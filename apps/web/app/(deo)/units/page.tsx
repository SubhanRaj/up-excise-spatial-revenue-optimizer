    ...
    <div className="space-y-6 w-full">
      ...
      <HelpPanel
        ...
        childrenHi={<>
          ...
          <p><strong>चरण 4 — Download district data</strong> Upload page से (आपके circles/sectors लॉक होते ही यह अपने-आप unlock हो जाता है)।</p>
      ...
      >
        ...
        <p><strong>Step 4 — Download district data</strong> from the Upload page (unlocked automatically once your circles/sectors are locked).</p>
