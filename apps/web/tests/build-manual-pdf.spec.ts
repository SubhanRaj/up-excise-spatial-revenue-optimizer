...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    titleEn: '18. Submitted — Then the Final Verification Round',
    titleHi: '१८. सबमिट हुआ — फिर अंतिम सत्यापन दौर',
    textEn: 'A success message confirms your district is submitted to Headquarters. The Verify page switches to a read-only view. When Headquarters opens the Final Verification Round, your Verify page shows your district\'s totals once more: check them and tap "Everything is correct — Confirm & Verify", entering your name again. Your district then moves from "Submitted" to "Verified". If you spot wrong data at this stage, tap "Request Unlock" instead — an Admin can approve a correction (see Section 23).',
    textHi: 'एक सफलता संदेश पुष्टि करता है कि आपका जिला मुख्यालय को सबमिट हो गया है। Verify पेज read-only हो जाता है। जब मुख्यालय अंतिम सत्यापन दौर (Final Verification Round) खोलता है, तो आपका Verify पेज एक बार फिर आपके जिले के कुल आंकड़े दिखाता है: उन्हें जांचें और अपना नाम दोबारा दर्ज करके "Everything is correct — Confirm & Verify" पर टैप करें। आपका जिला "Submitted" से "Verified" हो जाता है। इस चरण पर गलत डेटा दिखे तो "Request Unlock" पर टैप करें — Admin सुधार स्वीकृत कर सकता है (देखें खंड २३)।',
  },
  {
