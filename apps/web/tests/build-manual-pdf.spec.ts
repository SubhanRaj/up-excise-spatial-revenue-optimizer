...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    titleEn: '18. Submitted — Then Confirm & Verify',
    titleHi: '१८. सबमिट हुआ — फिर Confirm & Verify',
    textEn: 'A success message confirms your district is submitted to Headquarters, and your Verify page switches to a read-only view showing your district\'s totals. Check them once more and tap "Everything is correct — Confirm & Verify", entering your name again. Your district then moves from "Submitted" to "Verified". You do this straight away — there is no state-wide round to wait for, and you do not wait for other districts. If you spot wrong data at this stage, tap "Request Unlock" instead — an Admin can approve a correction (see Section 23).',
    textHi: 'एक सफलता संदेश पुष्टि करता है कि आपका जिला मुख्यालय को सबमिट हो गया है, और आपका Verify पेज read-only होकर आपके जिले के कुल आंकड़े दिखाता है। उन्हें एक बार फिर जांचें और अपना नाम दोबारा दर्ज करके "Everything is correct — Confirm & Verify" पर टैप करें। आपका जिला "Submitted" से "Verified" हो जाता है। यह आप तुरंत करते हैं — किसी राज्य-स्तरीय दौर या अन्य जिलों की प्रतीक्षा नहीं। इस चरण पर गलत डेटा दिखे तो "Request Unlock" पर टैप करें — Admin सुधार स्वीकृत कर सकता है (देखें खंड २३)।',
  },
  {
    file: '16-admin-district-detail.png',
    titleEn: '19. After You Verify — Deputy Review & Division Lock',
    titleHi: '१९. सत्यापन के बाद — उप आयुक्त की समीक्षा और मंडल लॉक',
    textEn: 'Once your district is "Verified", your Deputy Excise Commissioner reviews it in their division portal — the same shop-by-shop figures you entered (shown here for your awareness; you do not have this view). The Deputy records either "Looks correct" or "Flag an issue"; if they flag it, an Admin may open a correction unlock so you can fix the shop(s) and verify again. When every district in the division is verified and the Deputy has signed off on each, the Deputy locks the division. After a division is locked, any further correction goes through state Headquarters, not a DEO request. When all 18 divisions are locked, the state\'s data collection is closed.',
    textHi: 'जब आपका जिला "Verified" हो जाता है, तो आपके उप आबकारी आयुक्त उसे अपने मंडल पोर्टल में देखते हैं — वही दुकान-दर-दुकान आंकड़े जो आपने दर्ज किए (यहां केवल आपकी जानकारी के लिए दिखाया गया; यह व्यू आपके पास नहीं है)। उप आयुक्त "Looks correct" या "Flag an issue" दर्ज करते हैं; flag करने पर Admin सुधार के लिए unlock खोल सकता है और आप दोबारा verify करते हैं। जब मंडल का हर जिला verify हो जाए और उप आयुक्त ने हर एक पर हस्ताक्षर कर दिया हो, तो वे मंडल lock कर देते हैं। मंडल lock होने के बाद कोई भी सुधार राज्य मुख्यालय से होता है, DEO अनुरोध से नहीं। जब सभी 18 मंडल lock हो जाते हैं, राज्य का डेटा संग्रह बंद हो जाता है।',
  },
  {
