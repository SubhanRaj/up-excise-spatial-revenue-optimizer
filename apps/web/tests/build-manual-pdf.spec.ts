...
function buildRevenueFormulasSection(): Section {
  const rows: [string, string, string, string][] = [
    ...
    ['COMPOSITE_SHOP', 'composite_lf_fl + composite_lf_beer + composite_mgr_fl + composite_mgr_beer', 'All four sub-component fields are required — the Foreign Liquor and Beer portions of both LF and MGR.', 'चारों sub-component fields भरना अनिवार्य है — LF और MGR दोनों के Foreign Liquor और Beer वाले हिस्से।'],
